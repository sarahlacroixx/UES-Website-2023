  ...
  if ((carouselRun = 1)) {
    setTimeout(function () {
      ...
      if (i != 0) {
        ...
        document.getElementById("circle" + carouselSize).style.backgroundColor =
          circleColor;
      }
      document.getElementById("slide" + next).style.display = "block";
      document.getElementById("slide" + next).style.opacity = "1";
      document.getElementById("circle" + next).style.backgroundColor =
        "rgba(255, 255, 255, 1)";
...
let aboutDropdown = document.getElementById("about-us-dropdown");
let joinMenu = document.getElementById("menu-join");
let joinDropdown = document.getElementById("join-dropdown");
let eventMenu = document.getElementById("menu-events");
let eventDropdown = document.getElementById("events-dropdown");
let docMenu = document.getElementById("menu-documents");
...
eventMenu.addEventListener("mouseenter", function () {
  fadeIn(eventDropdown);
});

eventMenu.addEventListener("mouseleave", function () {
  fadeOut(eventDropdown);
});

docMenu.addEventListener("mouseenter", function () {
  fadeIn(docDropdown);
});

docMenu.addEventListener("mouseleave", function () {
  fadeOut(docDropdown);
});

merchMenu.addEventListener("mouseenter", function () {
  fadeIn(merchDropdown);
  console.log("hi");
});

merchMenu.addEventListener("mouseleave", function () {
...
for (let i = 0; i < mobileMenuItems.length; i++) {
  ...
  mobileMenuItems[i].addEventListener("click", function () {
    if (menuButtonState == 0) {
      mobileMenuItems[i].querySelector(".mobile-menu-dropdown").style.display =
        "block";
      menuButtonState = 1;
    } else {
      mobileMenuItems[i].querySelector(".mobile-menu-dropdown").style.display =
...
for (let i = 0; i < clubContentBtn.length; i++) {
  clubContentBtn[i].addEventListener("click", function () {
    fadeIn(
      clubContentBtn[i].parentElement.parentElement.querySelector(
